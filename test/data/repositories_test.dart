...
void main() {
  group('Repositories', () {
    group('HttpRijksRepository', () {
      ...
      group('fetch', () {
        const String artDetailResponse = r'''{
          "artObject": {
            "links": {
        ...
        test('Smoke test for ArtDetail', () async {
          final Client client = clientWithOkResponse(artDetailResponse);
        ...
        test('Cache request', () async {
          final MockBaseClient client = MockBaseClient();
          when(() => client.get(any())).thenAnswer((_) async => okResponse(artDetailResponse));

          final HttpRijksRepository repo = HttpRijksRepository(client, apiKey: '');
...
Response okResponse(String response) =>
    Response(response, 200, headers: <String, String>{'content-type': 'application/json; charset=utf-8'});

Client clientWithOkResponse(String response) => MockClient((_) async => okResponse(response));
